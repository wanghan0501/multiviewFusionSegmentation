...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features, norm_type=None):
        ...
        self.add_module('norm', NormSelector.Norm2d(norm_type)(num_input_features))
...
class DenseNet(nn.Module):
    ...
    def __init__(self, color_channels=3, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features = nn.Sequential(OrderedDict([
            ('conv0', nn.Conv2d(color_channels, num_init_features, kernel_size=7, stride=2, padding=3, bias=False)),
            ('norm0', NormSelector.Norm2d(norm_type)(num_init_features)),
            ('relu0', nn.ReLU(inplace=True)),
            ('pool0', nn.MaxPool2d(kernel_size=3, stride=2, padding=1)),
        ]))

        # Each denseblock
        self.num_features_list = list()
        ...
        for i, num_layers in enumerate(block_config):
            ...
            self.num_features_list.append(num_features)

        self.num_features = num_features
        # Final batch norm
        self.features.add_module('norm5', NormSelector.Norm2d(norm_type)(num_features))
